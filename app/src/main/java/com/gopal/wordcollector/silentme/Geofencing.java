    ...
    public void updateGeofencesList(PlaceBuffer places) {
        ...
        for (Place place : places) {
            ...
            Geofence geofence = new Geofence.Builder()
                    .setRequestId(placeUID)           //Geofence ObjectId
                    .setExpirationDuration(GEOFENCE_TIMEOUT)  // lifetime of Geofence
                    .setCircularRegion(placeLat, placeLng, GEOFENCE_RADIUS)  // Radius of Geofence
                    .setTransitionTypes(Geofence.GEOFENCE_TRANSITION_ENTER | Geofence.GEOFENCE_TRANSITION_EXIT)   // Transition
                    .build();
            // Add it to the list
